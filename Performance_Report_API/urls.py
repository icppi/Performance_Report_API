...
from API.Report.views import lifting_list_view, month_statistical_rate_view, transfer_performance_data_view, top_view, login_view, index_view, panel_view, user_view, group_view, development_data_view, performance_data_view, return_data_view, statistical_rate_view, statistical_echarts_view, high_seas_data_view
...
urlpatterns = [
    ...
    path('top/', top_view),
    path('lifting-list-data/', lifting_list_view),
    path('month-statistical-rate/', month_statistical_rate_view),
